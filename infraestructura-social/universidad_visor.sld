      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <!--<se:ExternalGraphic>
                <se:OnlineResource xlink:href="universidad_visor_v2.svg" xlink:type="simple"/>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              ...
              <se:Mark>
                <se:WellKnownName>file://universidad_visor_.svg.svg</se:WellKnownName>
                <se:Fill>
                  <se:SvgParameter name="fill">#a58c67</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              ...
              <se:Mark>
                <se:WellKnownName>file://universidad_visor_.svg</se:WellKnownName>
                <se:Fill>
                  <se:SvgParameter name="fill">#a58c67</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
